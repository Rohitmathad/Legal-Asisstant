...
function InputForm() {
  ...
  return (
    <div className="form1 bg-ivory min-h-screen">
      <div className="flex justify-center items-center pt-32 -mb-32 pb-20">
        <ul className="steps">
          <li className="step step-success text-black font-semibold">
      ...
      <div className="">
        {data.length > 0 && (
          <h1 className="text-black font-bold text-4xl pt-24 text-center -mb-24">
            {data[0].form_name}
          </h1>
        )}
        {displayForm ? (
            ...
            {category.length > 0 &&
              activeCategory === category[category.length - 1].id && (
                <div className="flex justify-center w-full p-7 ">
                  <button
                    type="submit"
                    className="p-4 text-lg font-bold text-black rounded bg-green-500 transform transition ease-in-out hover:scale-90 duration-150"
                  >
                    Submit
                  </button>
                </div>
          ...
          <div className="px-28 mt-48">
            ...
            <div className="flex justify-center">
              <button
                onClick={saveText}
                className="p-4 text-lg font-bold text-black rounded bg-green-500 transform transition ease-in-out hover:scale-90 duration-150 my-11"
              >
                Save
              </button>
              {displayHome && (
                <button
                  onClick={navHome}
                  className="p-4 ml-7 text-lg font-bold text-black rounded bg-red-300 transform transition ease-in-out hover:scale-90 duration-150 my-11"
                >
                  Home
                </button>
              )}
