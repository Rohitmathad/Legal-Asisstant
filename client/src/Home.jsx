...
<div className="content flex flex-row text-center justify-center gap-4">
<div className="first">
        <Typography
          variant="h2"
          color="white"
          className="font-bold text-4xl font-serif text-center text-black mb-2 "
          style={{
            fontFamily:
        ...
        {data.length > 0 && (
          <Typography
            variant="h2"
            color="white"
            className="font-bold text-4xl font-serif text-center text-black -mb-14 "
            style={{
              fontFamily:
                ' "DM Serif Display", "Open Sans", "PT Sans", sans-serif',
              marginTop: "60px",
